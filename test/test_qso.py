...
MULTI_VALUE_EXAMPLES = [
    ...
    (
        "foo&key=value1&foo=bar&key=value2&foo=baz&diz",
        {"key": ["value1", "value2"], None: ["foo", "diz"], "foo": ["bar", "baz"]},
    ),
    (
        "foo=bar&key=value1&diz=foo&key=value2&foo=baz",
        {"foo": ["bar", "baz"], "key": ["value1", "value2"], "diz": "foo"},
    ),
    # ('', {}),
]
