...
URI_COMPONENTS = [
    ...
    (
        ...
        dict(  # test_url_scheme ** Changing scheme does not alter port.
    ...
    (
        ...
        dict(  # test_spaces_with_multiple_ipv4_addresses **
            scheme="http",
    ...
    (
        ...
        dict(  # test_fragment_with_hostname **
            scheme="http",
    ...
    (
        ...
        dict(  # test_multiple_ats_within_authority
            scheme="http",
    ...
    (
        "http://foo@evil.com:80 @google.com/",
        dict(  # test_multiple_ats_and_space_within_authority **
            scheme="http",
            authority="foo@evil.com:80 @google.com",
            authentication="foo@evil.com:80 ",
            heirarchical="foo@evil.com:80 @google.com/",
    ...
    (
        ...
        dict(  # test_unicode_double_dot_if_stripped_bom
            scheme="http",
            authority="orange.tw",
    ...
    (
        ...
        dict(  # test_host_contains_tab_in_authority **
            scheme="http",
    ...
    (
        "http://localhost\\@google.com:12345/",
        dict(  # test_backslash_within_authority **
            scheme="http",
...
for _uri, _parts in URI_COMPONENTS:
    _parts["uri"] = _uri
    if "query" in _parts:
        _parts["qs"] = _parts["query"]
    if "host" in _parts:
        _parts["hostname"] = _parts["host"]
